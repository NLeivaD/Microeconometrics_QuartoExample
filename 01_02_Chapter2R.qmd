...
From this estimation we have obtained $\widehat{\tau}_{ATE}^* = -0.0602$ with a standard error of 0.0386 and a p-value of 0.12, much closer to be significative at conventional levels than $\widehat{\tau}_{ATE}$. The next step is to repeat the previous steps $B$ times and get $B$ estimates of $\widehat{\tau}_{ATE}$
...
This limits are shown with the red dashed lines in the empirical distribution and as seen in the empirical 95% confidence interval zero is included .
