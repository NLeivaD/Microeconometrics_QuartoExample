...
Same as @eq-twfe. also define the ATE for any ($s,t$) cell as: $$\Delta_{s,t} = \frac{1}{N_{s,t}} \sum_{i = 1}^{N_{s,t}}[Y_{i,s,t}(1) - Y_{i,s,t}(0)]$$ Next an example for the simple decomposition case. First is created the counterfactual
