...
@deChaisemartinDhaultfoeuille2019 define the ATE for any ($s,t$) cell as: $$\Delta_{s,t} = \frac{1}{N_{s,t}} \sum_{i = 1}^{N_{s,t}}[Y_{i,s,t}(1) - Y_{i,s,t}(0)]$$ Next an example for the simple decomposition case. First is created the counterfactual
...
california_data_url <- "C:\\Users\\maria\\Desktop\\RA Microeconometría\\Cap4\\data-abadie-diamond-hainmueller-california-proposition-99-tobacco.csv"
